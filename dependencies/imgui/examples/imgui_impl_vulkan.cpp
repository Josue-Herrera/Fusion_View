...
void ImGui_ImplVulkan_UpdateFontsTexture(VkCommandBuffer command_buffer)
{
    ImGui_ImplVulkan_InitInfo* v = &g_VulkanInitInfo;
    ...
    if ((!g_FontView) || (g_FontTextureWidth != width) || (g_FontTextureHeight != height))
    {
    ...
    {
        size_t upload_size = dirty_width * dirty_height * 4 * sizeof(char);
        ...
        // Upload to Buffer:
        {
            ...
            else
            {
                ...
                const int dest_stride = dirty_width * 4;
        ...
        // Copy to Image:
        {
            ...
            region.imageOffset.x = dirty_x;
            region.imageOffset.y = dirty_y;
            region.imageExtent.width = dirty_width;
            region.imageExtent.height = dirty_height;
            region.imageExtent.depth = 1;
            region.bufferOffset = 0;
            region.bufferRowLength = dirty_width;
            region.bufferImageHeight = dirty_height;
