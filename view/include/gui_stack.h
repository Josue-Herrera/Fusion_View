...
namespace fv {
	...
	public:
		...
		[[nodiscard]] std::vector<Layer*>::const_iterator begin() const { return gui_layers.begin(); }
		[[nodiscard]] std::vector<Layer*>::const_iterator end()	const { return gui_layers.end(); }
		[[nodiscard]] std::vector<Layer*>::const_reverse_iterator rbegin() const { return gui_layers.rbegin(); }
		[[nodiscard]] std::vector<Layer*>::const_reverse_iterator rend() const { return gui_layers.rend(); }
	private:
